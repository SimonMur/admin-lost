...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { county_id: @area.county_id, description: @area.description, name: @area.name } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { county_id: @area.county_id, description: @area.description, name: @area.name } }
