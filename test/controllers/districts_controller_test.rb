...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { description: @district.description, keyword: @district.keyword, name: @district.name } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { description: @district.description, keyword: @district.keyword, name: @district.name } }
