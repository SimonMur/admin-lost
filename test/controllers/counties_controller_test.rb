...
class CountiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create county" do
    assert_difference('County.count') do
      post counties_url, params: { county: { county_code: @county.county_code, description: @county.description, name: @county.name } }
    end
  ...
  test "should update county" do
    patch county_url(@county), params: { county: { county_code: @county.county_code, description: @county.description, name: @county.name } }
